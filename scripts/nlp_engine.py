...
device = flowx.Device.connect("emulator-5554")  # Android
...
请只输出 Python 代码，不要有任何解释。代码必须以 import flowx 开头。"""

        # 使用 httpx 替代 requests，避免连接问题
        import httpx
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 nlp_engine.py <natural language command>")
        print('Example: python3 nlp_engine.py "打开 Safari 并搜索 anthropic"')
        sys.exit(1)
